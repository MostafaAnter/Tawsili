...
public class CustomRequest extends JsonRequest<JSONArray> {
     ...
     */
    public
    CustomRequest(int method, String url, JSONArray jsonRequest, Response.Listener<JSONArray> listener, Response.ErrorListener errorListener) {
     ...
     *
     * @seeMyjsonPostRequest(int, String, JSONArray, Listener, ErrorListener)
     */
