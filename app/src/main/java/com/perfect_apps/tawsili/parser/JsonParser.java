...
public class JsonParser {
    ...
    public static TreeSet<DriverModel> parseDriversListReturnList(String userLat, String userLng, String feed){
        JSONArray driversArray = null;
        try {
            driversArray = new JSONArray(feed);
        } catch (JSONException e) {
    ...
    public static List<SchedualObject> parseScheduleList(String feed){
